...
manager_agent.prompt_templates["system_prompt"] += """Always save the output files generated by you in the folder 'output'. In example, if you create a file named 'file.txt', you should save it in the folder 'output', so it should be in the path 'output/file.txt'."""
